...
/**
 * Migration to create the world_countries table.
 * 
 * This table stores information about countries including their names,
 * codes, currency information, and geographical data.
 */
class CreateWorldCountriesTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('world_countries', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('continent_id')->comment('Continent ID');
            ...
            $table->boolean('has_division')->default(false)->comment('Has Division');
